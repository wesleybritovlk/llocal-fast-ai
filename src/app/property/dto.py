...
class Request:
    class PropertyCreate(BaseModel):
        ...
        address_full: str = Field(..., example="2232 Avenida Brigadeiro Faria Lima, São Paulo - SP - Brasil", description="Full address of the property: number street, city - state - country")
